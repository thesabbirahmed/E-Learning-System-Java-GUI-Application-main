...
public class AboutDevelopers extends JFrame{
    ...
    public AboutDevelopers() {
        ...
        String[][] rowData = {{"1902001", "Sabbir Ahmed", "<html>Code Development</html>"}, 
                               {"1902002", "Mobassira Islam", "<html>Mysql Integration</html>"}};
        String columns[] = {"Uni ID", "Name", "Contributions"};
